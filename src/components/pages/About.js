        ...
        <div className='about'>
          <div className='FR'>
            <p>
              ...
              l’Atelier Supérieur d’Animation, à Paris. C’est durant leurs
            ...
            <p>
              ...
              éditions. 99° se définit à la fois par la diversité des styles
              qu’il regroupe, et par leur compatibilité et complémentarité. Ce
              mélange de différents styles et idées peut ainsi être exploité en
              fonction des spécificités de chaque projet.
            </p>
          </div>
          ...
          <div className='ENG'>
            ...
            <p>
              ...
              commissioned work, as well as through the production of
              exhibitions and publications. 99° is defined both by the diversity
              of personal styles it fosters and by the compatibility of these
              diverse practices. The collective’s commitment to cooperative work
              can thus be harnessed according to the specificities of each
              project.
            </p>
          </div>
        </div>
